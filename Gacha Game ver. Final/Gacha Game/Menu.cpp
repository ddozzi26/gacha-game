...
void Menu::ShowDescription() {
    std::cout << "\n게임 설명:\n";
    std::cout << "W/S 키로 전투기를 위/아래로 이동하세요.\n스페이스바로 총알을 발사해 적을 격추하세요\n";
    std::cout << "d 키로 5성 전투기 스킬을 사용하여 적을 즉시 제거할 수 있습니다 (쿨다운 10초).\n";
    std::cout << "적과 충돌하면 목숨을 잃고 주어진 목숨을 다 잃게 되면 게임이 종료됩니다.\n";
    std::cout << "쥬얼은 가챠 재화로, 쥬얼을 이용하여 5성 전투기와 무기를 얻을 수 있습니다.\n";
    std::cout << "슈팅 게임 처치를 통해 쥬얼을 보급받을 수 있습니다.\n\n";
}
